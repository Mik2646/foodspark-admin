...
import { BanknoteArrowDown, Download, RefreshCcw } from "lucide-react";
...
export default function FinancePage() {
  ...
  return (
    <div>
      ...
      {(settlement.error || payoutOverview.error || payoutList.error) && (
        <div className="mb-4 rounded-lg bg-red-50 border border-red-100 text-red-700 text-sm px-3 py-2">
          {settlement.error?.message || payoutOverview.error?.message || payoutList.error?.message}
        </div>
      )}
